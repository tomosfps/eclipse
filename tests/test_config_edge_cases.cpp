...
void testEdgeCases(ConfigTestRunner& runner) {
    ...
    // Test .env with comments and whitespace
    {
        ...
        runner.test("Parse .env with comments and whitespace", loaded && logger.getLogLevel() == LogLevel::INFO);
    ...
    // Test .ini with multiple sections
    {
        ...
        runner.test("Parse .ini with multiple sections", loaded && logger.getLogLevel() == LogLevel::ERR);
    ...
    // Test case insensitive log levels
    {
        ...
        runner.test("Case insensitive log level parsing", loaded && logger.getLogLevel() == LogLevel::DEBUG);
    ...
    // Test quoted values
    {
        ...
        runner.test("Parse quoted log level values", loaded && logger.getLogLevel() == LogLevel::WARN);
